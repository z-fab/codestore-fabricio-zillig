        ...
        <div className="w-full min-w-64 h-28 rounded-xl overflow-hidden border p-2 flex flex-row mb-3 justify-between">
            <div className="flex flex-row  w-11/12">
                <div className="h-full w-16 overflow-hidden rounded-lg flex justify-center items-center bg-gray-100">
                    <img className="h-auto max-w-full object-cover object-center" src="https://images.unsplash.com/photo-1509423350716-97f9360b4e09?q=80&w=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Imagem do Produto" style={{ height: "200px" }} />
                </div>
